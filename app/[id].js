...
const ItemView = () => {
  ...
  return (
    <>
      <Stack.Screen options={{ title: "Item view" }} />
          ...
          <View style={style.content}>
            <View>
              ...
              <View style={style.itemContainer}>
                ...
                <Text style={style.item}>Name: {user.name}</Text>
                <Text style={style.item}>Email: {user.email}</Text>
                <Text style={style.item}>Phone: {user.phone}</Text>
              </View>
            </View>
            ...
            <View>
              ...
              <View style={style.itemContainer}>
                <Text style={style.item}>Name: {user.company.name}</Text>
                <Text style={style.item}>
                  Catchphrase: {user.company.catchPhrase}
                </Text>
                <Text style={style.item}>BS: {user.company.bs}</Text>
              </View>
            </View>

            <View>
              <Text style={style.title}>Misc. Information</Text>

              <View style={style.itemContainer}>
                <Text style={style.item}>Misc: {user.website}</Text>
              </View>
            </View>
          </View>
        ) : null}
